### _Note: as of `Phantom v24.9.x`, the KDF has switched from `pbdfk2` to `script` and is not yet supported by `phantom_decryptor`. See issue: https://github.com/cyclone-github/phantom_pwn/issues/3_
